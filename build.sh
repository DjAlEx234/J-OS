...
i686-elf-gcc -c ./IO/serial.c -o ./Output/serial.o -std=gnu99 -ffreestanding -O2 -Wall -Wextra -I"./Headers/"
...
qemu-system-i386 -kernel ./J-OS.bin -d guest_errors -serial file:./serial.txt
rm -r Output
rm serial.txt